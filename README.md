...
Просмотр проекта: https://vintius.github.io/teleprofit/  
...
* скачайте сборку с помощью [Git](https://git-scm.com/downloads): ```git clone https://github.com/Vintius/teleprofit.git```
